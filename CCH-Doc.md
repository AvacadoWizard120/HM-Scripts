...
If anybody wants to contribute to this doc, please contribute!
...
function registerCommands() {
	if (CCH != null) {
		...
		CCH.registerCommand(
			...
			[
				["bool", "action", false] -- a table of arguments the command takes, each argument is registered as an array [type (string), variable name (string), required (bool)]
			],
